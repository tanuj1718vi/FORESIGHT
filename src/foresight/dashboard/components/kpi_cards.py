...
def render_kpi_card(
    ...
    <div class="glow-card-3d" style="
        ...
        padding: 18px 22px;
        margin-bottom: 16px;
        box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.5), 0 0 15px -3px {cfg['glow']};
        transition: all 0.35s cubic-bezier(0.4, 0, 0.2, 1);
        overflow: hidden;
        transform: perspective(1000px) translateZ(0);
    ">
        <!-- Ambient Neon Glow Orb in Corner -->
        <div style="
            position: absolute;
            top: -20px;
            right: -20px;
        ...
        <div style="
            ...
            margin-top: 8px;
            text-shadow: 0 2px 10px rgba(0, 0, 0, 0.5), 0 0 20px {cfg['glow']};
